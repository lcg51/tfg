...
Una vez finalizado el desarrollo de la aplicación, se lleva acabo un análisis y prueba de la aplicación. De los resultados obtenidos se evaluan
las funcionalidades y de este modo saber que objetivos se han cumplido.
